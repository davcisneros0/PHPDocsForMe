        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/about" class="<?= $_SERVER['REQUEST_URI'] == '/about' ? 'bg-gray-900 text-white' : 'text-gray-300'?>rounded-md bg-gray-900 rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About Us</a>
              <a href="/notes" class="<?= $_SERVER['REQUEST_URI'] == '/notes' ? 'bg-gray-900 text-white' : 'text-gray-300'?>rounded-md bg-gray-900 rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Notes</a>
